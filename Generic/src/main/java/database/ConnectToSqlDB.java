...
public class ConnectToSqlDB {
    ...
    public static Properties loadProperties() throws IOException{
        ...
        InputStream ism = new FileInputStream("D:\\Final_Project_FrameWork\\Generic\\src\\secret.properties");
...

    {
        ...
        try {
            ...
            ps = connect.prepareStatement("CREATE TABLE `"+tableName+"` ("+columnName+" varchar(50) );");
